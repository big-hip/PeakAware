...
def _search_diagnostics_row(result: OptimizedTrainingResult) -> dict[str, Any] | None:
    ...
    return {
        ...
        "diagnostic_hint_candidate_match_count": diagnostics.diagnostic_hint_candidate_match_count,
        "diagnostic_hint_order_changed": diagnostics.diagnostic_hint_order_changed,
        "diagnostic_hint_order_delta_count": diagnostics.diagnostic_hint_order_delta_count,
