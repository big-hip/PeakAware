...
optimizer = SGD_Optimizer(list(model.parameters()), lr=learning_rate)
...
optimizer=aten_compile_capture(optimizer.step)
""" 用户参考 end"""
...
# 调用 pass
"""用户参考 start"""
Dist_IR.Hybrid_Parallel_pass(graph_capture.FW_gm, graph_capture.BW_gm, batch_size)
"""用户参考 end"""
